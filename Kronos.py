...
class Kronos(object):
    def __init__(self, wake_word_model_state_path, speech_recognition_model_state_path,
            ...
            language_model_path, wake_notification_wav_path):
        ...
        if self.recording_speech:
            ...
            if self.speech_buffer.shape[0] >= 8000 * 4:
                ...
                for result in top_language_model_results:
                    confidence, intent = inferIntentAndSlots(result, self.intent_and_slot_models)
                ...
                print(most_confident_result, "||", most_confident_intent, "||", highest_confidence)
...
if __name__ == "__main__":
    Kronos("data/wake_word_model_state.torch","data/speech_model_state.torch",
           "data/intent_model_state.torch","data/slot_model_state.torch",
           "data/language_model.arpa","data/wake.wav").start()
